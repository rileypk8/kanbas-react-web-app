        ...
        <div className="card"
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              Waldorf & Statler will have their Rave at the Museum of Science, complete with vows in the Theater of Electricity, just not in 2020. For now, this planned in 2 days, with a high fever & FLU-A positive, while on-crutches ceremony will do.
            </p>
