  ...
  return (
    <ul className="nav nav-pills">
      ...
      <li className="nav-item"><a id="wd-a4" href="#/Labs/Lab4"
        ...
        <li className="nav-item"><a id="wd-a3" href="#/Labs/Lab6"
          className={`nav-link ${pathname.includes("Lab6") ? "active" : ""}`}>
          Lab 6
        </a>
        </li>
      <li className="nav-item"><a id="wd-k" href="#/Kanbas" className="nav-link">
          Kanbas
        </a>
      </li>
      <li className="nav-item"><a id="wd-g" href="https://github.com/rileypk8/kanbas-react-web-app/" className="nav-link">
          MyGithub
        </a>
      </li>
    </ul>
